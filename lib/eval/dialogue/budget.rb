...
module Eval::Dialogue::Budget
  ...
  class Ledger
    ...
    def reserve!(label:, input_cap:, output_cap: MAX_OUTPUT_TOKENS)
      ...
      edit do |data|
        ...
        raise Halt, "Dialogue $2 evaluation budget cannot reserve the next call" if charged + reservation > LIMIT_MICROS
  ...
  module AgentCalls
    def ask(prompt, **options, &block)
      ...
      ticket = Eval::Dialogue::Budget.ledger.reserve!(label: "#{Eval::Dialogue::Budget.label}:#{purpose}", input_cap: input_cap)
      Eval::Dialogue::Budget.calls << receipt
      ...
      begin
        ...
        Eval::Dialogue::Budget.ledger.settle!(ticket, receipt)
      end
    end
  end
  ...
  module ChatCalls
    def ask(*args, **options, &block)
      ...
      if receipt
        receipt.merge!(Eval::Dialogue::Budget.usage(result))
