...
class Story::Scoreboard
  ...
  CHECKS = {
    ...
    dead_shown_alive: "the prose has somebody the engine's receipt records dead acting alive",
    carried_shown_lying: "the prose has a thing the engine's receipt says the player carries lying somewhere",
    handover_invented: "the prose hands the player something on a turn whose receipt says nothing changed hands",
